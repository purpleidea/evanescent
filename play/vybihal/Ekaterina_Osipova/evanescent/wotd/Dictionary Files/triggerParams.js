/****Customer: Ask.com - Dictionary.com
...
foresee.triggerParms["mid"] = "Bd1IwcR8Zo45JkFhh4BlFA==";   // model instance id (Default is XYZ Company survey) - Comment if using 'sid'

foresee.triggerParms["cid"] = "B2QN5u13z0SifZFiOEGnoA==";   // customer id

foresee.triggerParms["lf"] = 1;		 	      	   			// loyalty factor

foresee.triggerParms["sp"] = 0.05;	 		      			// sampling percentage
...
foresee.triggerParms["domain"] = ".reference.com";   // domain name

foresee.triggerParms["dhtmlURL"] ="/fsrscripts/FSRInvite.html";// path to survey invitation
