...
import socket				# for gethostname() and getfqdn() PLUS: gethostbyname() for IPV4
			...
			try:
				...
				for i in data:
					...
					for j in i.keys():
						...
						# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!NEW: GET IPV4 and compare!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
						elif j == IPV4:
							# uses: socket.gethostbyname(socket.gethostname()
							# uses: uses python to get IPV4 compares it, due to import of socket
